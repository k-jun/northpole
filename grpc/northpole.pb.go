...
const (
	MatchStatus_Availabel   MatchStatus = 0
	MatchStatus_Unavailabel MatchStatus = 1
)
...
func (x *MatchInfo) GetStatus() MatchStatus {
	...
	return MatchStatus_Availabel
}

func (x *MatchInfo) GetCurrentNumberOfUsers() int64 {
	if x != nil {
...
func (x *MatchInfo) GetMaxNumberOfUsers() int64 {
	if x != nil {
...
var file_northpole_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x12, 0x09, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x0a, 0x2e, 0x4d, 0x61,
	0x74, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x00, 0x30, 0x01, 0x12, 0x35, 0x0a, 0x10, 0x4a,
...
func (c *northPoleClient) CreatePrivateMatch(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (NorthPole_CreatePrivateMatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NorthPole_serviceDesc.Streams[1], "/NorthPole/CreatePrivateMatch", opts...)
	if err != nil {
		return nil, err
	}
	x := &northPoleCreatePrivateMatchClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type NorthPole_CreatePrivateMatchClient interface {
	Recv() (*MatchInfo, error)
	grpc.ClientStream
}

type northPoleCreatePrivateMatchClient struct {
	grpc.ClientStream
}

func (x *northPoleCreatePrivateMatchClient) Recv() (*MatchInfo, error) {
	m := new(MatchInfo)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *northPoleClient) JoinPrivateMatch(ctx context.Context, in *MatchIDAndUserID, opts ...grpc.CallOption) (NorthPole_JoinPrivateMatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NorthPole_serviceDesc.Streams[2], "/NorthPole/JoinPrivateMatch", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedNorthPoleServer) CreatePrivateMatch(*UserInfo, NorthPole_CreatePrivateMatchServer) error {
	return status.Errorf(codes.Unimplemented, "method CreatePrivateMatch not implemented")
}
...
func _NorthPole_CreatePrivateMatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(UserInfo)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(NorthPoleServer).CreatePrivateMatch(m, &northPoleCreatePrivateMatchServer{stream})
}

type NorthPole_CreatePrivateMatchServer interface {
	Send(*MatchInfo) error
	grpc.ServerStream
}

type northPoleCreatePrivateMatchServer struct {
	grpc.ServerStream
}

func (x *northPoleCreatePrivateMatchServer) Send(m *MatchInfo) error {
	return x.ServerStream.SendMsg(m)
}

func _NorthPole_JoinPrivateMatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(MatchIDAndUserID)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
...
var _NorthPole_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreatePrivateMatch",
			Handler:       _NorthPole_CreatePrivateMatch_Handler,
			ServerStreams: true,
		},
		{
